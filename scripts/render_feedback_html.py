...
.OK{color:var(--ok)}.BAD{color:var(--bad)}.OVR{color:var(--ovr)}.PEND{color:var(--pend)}.PEND_HEADLESS{color:var(--pend);opacity:.65}.CLOSED_UNVERIFIED{color:var(--pend);opacity:.5}
