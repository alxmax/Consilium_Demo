...
8. **Verdictul e advisory** — user-ul decide:
   ...
   - `MODIFY` (default — splits ne-polarizate sau cu absentări) → aplică `modify_requests` și (opțional) re-rulează
...
| `confidence ∈ [0.5, 0.7]` from standard mode AND single drift concern | `dialectic_skeptic` |
