...
2. **Then the justification**, covering:
   - Why this option is the right choice. **If you pick B ("Other Variant"), you MUST first state in one sentence what the variant is** — a concrete alternative not listed in A–D 
