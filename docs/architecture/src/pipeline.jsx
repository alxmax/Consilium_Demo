...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'Conditional — runs only when the prompt declared Required output files or Deliverables. infer_pipeline.py deduces and executes the implementation steps after step 6. Skipped if chosen_approach ∈ {do_nothing, skipped}. Headless flag: --yes. Opt-in companion: render_impl_preview.py renders the report + working-tree diff as a self-contained HTML review page for pre-commit handoff — never part of the dispatch flow.',
    ...
    scripts: ['infer_pipeline.py', 'render_impl_preview.py'],
  },
];
