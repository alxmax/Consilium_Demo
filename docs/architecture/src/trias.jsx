  ...
  return (
    <div style={{
      ...
      <svg viewBox="0 0 880 360" className="diagram" aria-label="Lazy routing decision flow">
        ...
        <path d="M 410 208 C 460 240, 540 280, 660 280" stroke="var(--ink-3)" strokeWidth="1.4" strokeDasharray="3 4" fill="none" markerEnd="url(#lr-arrow-faint)" />
        <text x="540" y="240" textAnchor="middle" style={{ fontFamily: 'var(--font-mono)', fontSize: 11, fill: 'var(--ink-3)' }}>trivial diff</text>
        <text x="540" y="254" textAnchor="middle" style={{ fontFamily: 'var(--font-mono)', fontSize: 9, fill: 'var(--ink-3)' }}>(skip · step 6 direct)</text>
        ...
        <g>
          <rect x="660" y="252" width="200" height="56" rx="4"
            fill="var(--paper-2)" stroke="var(--rule-2)" strokeDasharray="4 3" />
          <text x="760" y="274" textAnchor="middle" style={{ fontFamily: 'var(--font-sans)', fontSize: 13, fontWeight: 500, fill: 'var(--ink-2)' }}>scope_gate SKIP</text>
          <text x="760" y="291" textAnchor="middle" style={{ fontFamily: 'var(--font-mono)', fontSize: 10, fill: 'var(--ink-3)' }}>≤1 file · ≤15 lines</text>
        </g>
